(function (root, factory) {
  ...
  var LinkedHashMap_init_$Create$_0 = kotlin_kotlin.$_$.h1;
  var Map = kotlin_kotlin.$_$.b5;
  var IllegalArgumentException_init_$Init$ = kotlin_kotlin.$_$.a2;
  var captureStack = kotlin_kotlin.$_$.s8;
  var IllegalArgumentException_init_$Init$_0 = kotlin_kotlin.$_$.c2;
  var IllegalArgumentException_init_$Init$_1 = kotlin_kotlin.$_$.e2;
  var IllegalArgumentException_init_$Init$_2 = kotlin_kotlin.$_$.z1;
  ...
  var Iterator = kotlin_kotlin.$_$.w4;
  var Iterable = kotlin_kotlin.$_$.v4;
  ...
  var to = kotlin_kotlin.$_$.ae;
  var lazy_0 = kotlin_kotlin.$_$.td;
  ...
  var trimIndent = kotlin_kotlin.$_$.gc;
  ...
  var IndexOutOfBoundsException_init_$Create$ = kotlin_kotlin.$_$.m2;
  ...
  setMetadataFor(BinaryFormat, 'BinaryFormat', interfaceMeta, undefined, [SerialFormat], undefined, undefined, []);
  ...
  function PolymorphicSerializer$descriptor$delegate$lambda$lambda(this$0) {
    return function ($this$buildSerialDescriptor) {
      var tmp = serializer_1(StringCompanionObject_getInstance()).get_descriptor_wjt6a0_k$();
  ...
  function serializerByKTypeImpl(_this__u8e3s4, type, failOnMissingTypeArgSerializer) {
    ...
    if (typeArguments.isEmpty_y1axqb_k$()) {
      ...
      var tmp_0;
      if (tmp0_elvis_lhs == null) {
        tmp_0 = _this__u8e3s4.getContextual$default_i0obdx_k$(rootClass, null, 2, null);
      } else {
  ...
  function builtinSerializer(_this__u8e3s4, typeArguments, rootClass, failOnMissingTypeArgSerializer) {
    ...
    if (failOnMissingTypeArgSerializer) {
      ...
      while (tmp0_iterator.hasNext_bitz1p_k$()) {
        var item = tmp0_iterator.next_20eer_k$();
        tmp0_mapTo.add_1j60pz_k$(serializer_0(_this__u8e3s4, item));
      }
    ...
    if (((tmp0_subject.equals(getKClass(Collection)) ? true : tmp0_subject.equals(getKClass(List))) ? true : tmp0_subject.equals(getKClass(MutableList))) ? true : tmp0_subject.equals(getKClass(ArrayList))) {
      ...
      if (isReferenceArray(rootClass)) {
        ...
        var tmp2_cast = ArraySerializer((!(tmp_2 == null) ? isInterface(tmp_2, KClass) : false) ? tmp_2 : THROW_CCE(), serializers.get_fkrdnv_k$(0));
        tmp$ret$5 = isInterface(tmp2_cast, KSerializer) ? tmp2_cast : THROW_CCE();
        return tmp$ret$5;
      }
      var tmp$ret$6;
  ...
  function reflectiveOrContextual(_this__u8e3s4, kClass, typeArgumentsSerializers) {
    ...
    return tmp0_elvis_lhs == null ? _this__u8e3s4.getContextual_r3x7wt_k$(kClass, typeArgumentsSerializers) : tmp0_elvis_lhs;
  }
  ...
  function prepareHighMarksArray($this, elementsCount) {
    ...
    var elementsInLastSlot = elementsCount & (Companion_getInstance().get_SIZE_BITS_7qhjj9_k$() - 1 | 0);
  ...
  function markHigh($this, index) {
    ...
    var offsetInSlot = index & (Companion_getInstance().get_SIZE_BITS_7qhjj9_k$() - 1 | 0);
  ...
  function nextUnmarkedHighIndex($this) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var slotOffset = imul(slot + 1 | 0, Companion_getInstance().get_SIZE_BITS_7qhjj9_k$());
  ...
  function ElementMarker(descriptor, readIfAbsent) {
    ...
    if (elementsCount <= Companion_getInstance().get_SIZE_BITS_7qhjj9_k$()) {
      var tmp = this;
      var tmp_0;
      if (elementsCount === Companion_getInstance().get_SIZE_BITS_7qhjj9_k$()) {
        tmp_0 = new Long(0, 0);
  ...
  ElementMarker.prototype.mark_xwbrr1_k$ = function (index) {
    if (index < Companion_getInstance().get_SIZE_BITS_7qhjj9_k$()) {
  ...
  function CharArraySerializer_0() {
    ...
    PrimitiveArraySerializer.call(this, serializer_10(Companion_getInstance_0()));
  }
  ...
  function init_properties_Primitives_kt_u7dn2q() {
    if (properties_initialized_Primitives_kt_6dpii6) {
      ...
      BUILTIN_SERIALIZERS = mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_1(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_10(Companion_getInstance_0())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_11(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_12(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_6(Companion_getInstance())), to(PrimitiveClasses_getInstance().get_longArrayClass_v379a4_k$(), LongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_7(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_9(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_8(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_13(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_14(Unit_getInstance()))]);
    }
  }
  ...
  _.$_$.m1 = shouldEncodeElementDefault;
  _.$_$.n1 = CompositeEncoder;
  _.$_$.o1 = decodeNullableSerializableValue;
  _.$_$.p1 = decodeSerializableValue;
  _.$_$.q1 = Decoder;
  _.$_$.r1 = beginCollection;
  _.$_$.s1 = encodeNotNullMark;
  _.$_$.t1 = encodeNullableSerializableValue;
  _.$_$.u1 = encodeSerializableValue;
  _.$_$.v1 = Encoder;
  _.$_$.w1 = AbstractPolymorphicSerializer;
  ...
  _.$_$.g2 = get_EmptySerializersModule;
  _.$_$.h2 = contextual;
