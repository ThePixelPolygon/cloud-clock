(function (root, factory) {
  ...
  var Appendable = kotlin_kotlin.$_$.cb;
  var coerceAtLeast = kotlin_kotlin.$_$.ia;
  var coerceAtMost_0 = kotlin_kotlin.$_$.ka;
  var Char__toInt_impl_vasixd = kotlin_kotlin.$_$.d3;
  var toRawBits = kotlin_kotlin.$_$.xd;
  var toRawBits_0 = kotlin_kotlin.$_$.yd;
  ...
  var CharSequence = kotlin_kotlin.$_$.lc;
  ...
  var isLowSurrogate = kotlin_kotlin.$_$.jb;
  var isHighSurrogate = kotlin_kotlin.$_$.ib;
  ...
  var replace$default = kotlin_kotlin.$_$.s;
  ...
  var IndexOutOfBoundsException_init_$Create$_0 = kotlin_kotlin.$_$.l2;
  ...
  function ByteChannelSequentialBase$awaitAtLeastNBytesAvailableForRead$lambda(this$0, $count) {
    return function () {
      return this$0.get_availableForRead_tq0sox_k$() < $count ? !this$0.get_closed_byjrzp_k$() : false;
    };
  }
      ...
      try {
        ...
        switch (tmp) {
          case 0:
            ...
            continue $sm;
          case 1:
            if (!(this._this__u8e3s4__1.get_availableForRead_tq0sox_k$() < this.count_1 ? !this._this__u8e3s4__1.get_closed_byjrzp_k$() : false)) {
  ...
  function writeFully_1(_this__u8e3s4, source, offset, length) {
    // Inline function 'io.ktor.utils.io.core.writeExact' call
    // Inline function 'kotlin.contracts.contract' call
    var tmp$ret$3;
    // Inline function 'io.ktor.utils.io.core.write' call
  ...
  function writeFully$default(_this__u8e3s4, source, offset, length, $mask0, $handler) {
    ...
    return writeFully_1(_this__u8e3s4, source, offset, length);
  }
  ...
  function writeFully_2(_this__u8e3s4, src, length) {
    ...
    try {
      $l$loop: while (true) {
        ...
        writeFully_0(tmp0__anonymous__q1qw7t, src, size);
  ...
  function writeFully_3(_this__u8e3s4, src, offset, length) {
    ...
    try {
      $l$loop: while (true) {
        ...
        writeFully_1(tmp0__anonymous__q1qw7t, src, tmp0__anonymous__q1qw7t_0, size);
        currentOffset = currentOffset + size | 0;
        remaining = remaining - size | 0;
        tmp$ret$2 = remaining > 0;
        if (!tmp$ret$2)
  ...
  function ByteReadChannel_0(content, offset, length) {
    ...
    $l$loop: while (true) {
      ...
      var size = tmp$ret$2;
      writeFully_1(tail instanceof Buffer ? tail : THROW_CCE(), content, start, size);
      start = start + size | 0;
      if (start === end)
        break $l$loop;
      var current = tail;
