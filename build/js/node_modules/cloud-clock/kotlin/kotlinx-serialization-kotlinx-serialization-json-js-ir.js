(function (root, factory) {
  ...
  var imul = Math.imul;
  var get_EmptySerializersModule = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.g2;
  ...
  var toLong_0 = kotlin_kotlin.$_$.ea;
  ...
  var ULong__toString_impl_f9au7k = kotlin_kotlin.$_$.r3;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.j3;
  var UByte__toString_impl_v72jg = kotlin_kotlin.$_$.l3;
  ...
  var isFinite = kotlin_kotlin.$_$.qd;
  var isFinite_0 = kotlin_kotlin.$_$.pd;
  var decodeNullableSerializableValue = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.o1;
  ...
  var IllegalArgumentException_init_$Create$_0 = kotlin_kotlin.$_$.b2;
  ...
  var encodeSerializableValue = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.u1;
  var shouldEncodeElementDefault = kotlin_org_jetbrains_kotlinx_kotlinx_serialization_core.$_$.m1;
  ...
  var Companion_getInstance_4 = kotlin_kotlin.$_$.j4;
  var charArray = kotlin_kotlin.$_$.u8;
  var StringBuilder_init_$Create$_0 = kotlin_kotlin.$_$.r1;
  var HashMap_init_$Create$ = kotlin_kotlin.$_$.b1;
  //endregion
  ...
  setMetadataFor(AbstractJsonTreeEncoder$encodeTaggedInline$1, undefined, classMeta, AbstractEncoder, undefined, undefined, undefined, []);
  ...
  function getJsonNameIndex(_this__u8e3s4, json, name) {
    ...
    var alternativeNamesMap = tmp.getOrPut_nie706_k$(_this__u8e3s4, tmp_0, buildAlternativeNamesMap$ref(_this__u8e3s4));
  ...
  PolymorphismValidator.prototype.polymorphicDefaultDeserializer_rsx40t_k$ = function (baseClass, defaultDeserializerProvider) {
  };
  ...
  StreamingJsonDecoder.prototype.decodeSerializableValue_6v83lo_k$ = function (deserializer) {
    try {
      ...
      if ($p instanceof MissingFieldException) {
        throw new MissingFieldException(plus($p.message, ' at path: ') + this.lexer_1.get_path_wos8ry_k$().getPath_18su3p_k$(), $p);
      } else {
        throw $p;
      }
    }
  ...
  StreamingJsonEncoder.prototype.encodeInline_8gn4q6_k$ = function (inlineDescriptor) {
    return get_isUnsignedNumber(inlineDescriptor) ? new StreamingJsonEncoder(new ComposerForUnsignedNumbers(this.composer_1.get_sb_kntnoo_k$()), this.json_1, this.mode_1, null) : AbstractEncoder.prototype.encodeInline_8gn4q6_k$.call(this, inlineDescriptor);
  };
  ...
  StreamingJsonEncoder.prototype.encodeFloat_f5fde1_k$ = function (value) {
    ...
    if (!this.configuration_1.get_allowSpecialFloatingPointValues_1eu5hp_k$() ? !isFinite(value) : false) {
      throw InvalidFloatingPointEncoded(value, this.composer_1.get_sb_kntnoo_k$().toString());
    }
  };
  ...
  JsonTreeDecoder.prototype.elementName_9sehmv_k$ = function (desc, index) {
    ...
    var tmp_0 = get_JsonAlternativeNamesKey();
    var alternativeNamesMap = tmp.getOrPut_nie706_k$(desc, tmp_0, buildAlternativeNamesMap$ref_0(desc));
    var tmp$ret$2;
  ...
  JsonTreeDecoder.prototype.endStructure_e64gd4_k$ = function (descriptor) {
    ...
    if (!this.configuration_1.get_useAlternativeNames_c5maqh_k$()) {
      ...
      var tmp0_safe_receiver = get_schemaCache(this.get_json_woos35_k$()).get_kuyzdy_k$(descriptor, get_JsonAlternativeNamesKey());
  ...
  PolymorphismValidator.prototype.polymorphicDefault_fs392_k$ = polymorphicDefault;
  ...
  AbstractJsonTreeEncoder$encodeTaggedInline$1.prototype.encodeSerializableValue_g55msp_k$ = encodeSerializableValue;
  AbstractJsonTreeEncoder$encodeTaggedInline$1.prototype.encodeNullableSerializableValue_4n8qik_k$ = encodeNullableSerializableValue;
