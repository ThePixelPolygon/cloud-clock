(function (root, factory) {
  ...
  function Companion() {
    ...
    while (inductionVariable < last) {
      ...
      tmp$ret$0 = element.r1s_1;
      tmp0_associateByTo.u2(tmp$ret$0, element);
    }
    tmp$ret$1 = tmp0_associateByTo;
    tmp$ret$2 = tmp$ret$1;
    tmp.s1s_1 = tmp$ret$2;
    this.t1s_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  Companion.prototype.u1s = function (code) {
    return this.s1s_1.v1(code);
  };
  ...
  CloseReason.prototype.x1s = function () {
    return Companion_getInstance().u1s(this.v1s_1);
  };
  CloseReason.prototype.toString = function () {
    var tmp0_elvis_lhs = this.x1s();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.v1s_1 : tmp0_elvis_lhs) + ', message=' + this.w1s_1 + ')';
  };
  CloseReason.prototype.hashCode = function () {
    var result = this.v1s_1;
  ...
  function Companion_0() {
    ...
    $l$block_0: {
      ...
      tmp$ret$2 = tmp1__anonymous__uwfjfc.b1t_1;
    ...
    tmp.c1t_1 = ensureNotNull(tmp$ret$1).b1t_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.c1t_1 + 1 | 0;
    var tmp$ret$4;
  ...
  function Text_init_$Init$_0(text, $this) {
    ...
    $l$block: {
      ...
      var tmp0_toByteArray = Charsets_getInstance().d18_1;
      if (tmp0_toByteArray.equals(Charsets_getInstance().d18_1)) {
        tmp$ret$0 = encodeToByteArray(text);
        break $l$block;
      }
      tmp$ret$0 = encodeToByteArray_0(tmp0_toByteArray.h18(), text, 0, text.length);
    }
  ...
  function Close_init_$Init$(reason, $this) {
    ...
    $l$block: {
      ...
      try {
        ...
        writeShort(builder, reason.v1s_1);
        writeText$default(builder, reason.w1s_1, 0, 0, null, 14, null);
  ...
  function Frame(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    this.f1t_1 = fin;
    this.g1t_1 = frameType;
    this.h1t_1 = data;
    this.i1t_1 = disposableHandle;
    this.j1t_1 = rsv1;
    this.k1t_1 = rsv2;
    this.l1t_1 = rsv3;
  }
  Frame.prototype.toString = function () {
    return 'Frame ' + this.g1t_1 + ' (fin=' + this.f1t_1 + ', buffer len = ' + this.h1t_1.length + ')';
  };
