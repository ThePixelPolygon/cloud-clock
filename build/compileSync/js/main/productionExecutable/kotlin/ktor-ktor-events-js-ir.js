(function (root, factory) {
  ...
  var addSuppressed = kotlin_kotlin.$_$.tb;
  ...
  function Events() {
    this.k2l_1 = new CopyOnWriteHashMap();
  }
  Events.prototype.l2l = function (definition, value) {
    var exception = null;
    var tmp0_safe_receiver = this.k2l_1.v1(definition);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlinx.coroutines.internal.LinkedListHead.forEach' call
      var cur = tmp0_safe_receiver.dn_1;
      while (!equals(cur, tmp0_safe_receiver)) {
        if (cur instanceof HandlerRegistration) {
          // Inline function 'io.ktor.events.Events.raise.<anonymous>' call
          var tmp0__anonymous__q1qw7t = cur;
          try {
            var tmp = tmp0__anonymous__q1qw7t.p2l_1;
